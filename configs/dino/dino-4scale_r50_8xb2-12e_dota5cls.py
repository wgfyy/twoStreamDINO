...
train_pipeline = [
    ...
    # 自适应缩放：将256x256的SAR图像resize到1024x1024，并同步缩放bbox
    # annotation_size表示标注是基于1024x1024创建的
    # target_size表示希望将图像resize到的尺寸
    # 先进行图像resize（256->1024），再进行bbox的相应缩放（1024->1024）
    dict(type='AdaptiveBboxScale', target_size=(1024, 1024), annotation_size=(1024, 1024)),
