...
model = dict(
    ...
    # Data preprocessor for dual-modal inputs (Optical + SAR)
    data_preprocessor=dict(
        type='DualModalDataPreprocessor',
        # Modality 1 (Optical/RGB) normalization
        mean=[123.675, 116.28, 103.53],
        std=[58.395, 57.12, 57.375],
        # Modality 2 (SAR) normalization - adjust based on your SAR data
        # For SAR converted to 3-channel grayscale, use similar values
    ...
    # Bbox head - 15 classes for DOTA-v1.0
    bbox_head=dict(
        type='DINOHead',
        num_classes=15,
...
# ==================== Dataset Config ====================
dataset_type = 'DualModalDOTADataset'
data_root = 'data/dual_modal_dota/'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='trainval/annotations/trainval.json',
        data_prefix=dict(
            img='trainval/optical/',   # Optical images
            img2='trainval/sar/'       # SAR images
        ),
